...
python run_toy_classification.py \
    ...
    --save_directory llama8b-instruct/prompt_testing/experiment_1/prompt_0
...
python run_toy_classification.py \
    ...
    --model_name meta-llama/Meta-Llama-3-8B-Instruct --model_ip 155.198.192.50 --model_port 6000 \
    --run_name 20_shot_15_z_15_random \
    --save_directory llama8b-instruct/prompt_testing/experiment_1/prompt_1 \
...
python run_toy_classification.py \
    ...
    --model_name meta-llama/Meta-Llama-3-8B-Instruct --model_ip 155.198.192.50 --model_port 6000 \
    --run_name 20_shot_15_z_15_random \
    --save_directory llama8b-instruct/prompt_testing/experiment_1/prompt_2 \
    --custom_prompt_text "This is a logistic regression dataset. Continue generating the dataset. ONLY generate lebel for next point in tags <output> </output>.\n{icl}\n\n Next point:\n {note} "
...
python run_toy_classification.py \
    ...
    --model_name meta-llama/Meta-Llama-3-8B-Instruct --model_ip 155.198.192.50 --model_port 6000 \
    --run_name 20_shot_15_z_15_random \
    --save_directory llama8b-instruct/prompt_testing/experiment_1/prompt_3 \
...
python run_toy_classification.py \
    ...
    --model_name meta-llama/Meta-Llama-3-8B-Instruct --model_ip 155.198.192.50 --model_port 6000 \
    --run_name 20_shot_15_z_15_random \
    --save_directory llama8b-instruct/prompt_testing/experiment_1/prompt_4 \
